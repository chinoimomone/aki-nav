      ...
      <aside id="sidebar" class="sidebar fixed left-0 top-0 h-full w-64 backdrop-blur-xl border-r border-white/30 dark:border-white/10 z-50 overflow-y-auto mobile-sidebar lg:ml-0 lg:transform-none transition-all duration-300">
        <div class="p-4">
          ...
          <div>
            ...
            <div class="space-y-1">
              <a href="?" class="flex items-center px-3 py-2 rounded-lg font-medium transition-colors ${!currentCatalog ? 'bg-primary-500/20 text-primary-600 dark:text-lime-200' : 'hover:bg-primary-500/10 text-slate-600 dark:text-gray-400'} w-full">
